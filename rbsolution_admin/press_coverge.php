...
<li><span class="bread-blod">Press Coverge</span>
</li>
</ul>
</div>
</div>
                    ...
                    <div class="col-md-4 ">
                      <!--   <div class="courses-inner res-mg-b-30"> -->
                            <!-- <div class="courses-title"> -->
                                <a href="#" title='Delete Record' data-toggle="modal" data-target="#deleteModal"   onclick="$('#del_id').val('<?php echo $id;?>');"><img src="<?php echo $image ?>" alt=""  width="100%" height="100%" class="project" ></a>
          ...
          $.ajax({
                  ...
                  success: function(data) 
                         ...
                         { 
                          ...
                          if(data==1) 
                            {
                            $("#profile_photo1").html('<div class="alert alert-success"><button type="button" class="close">×</button>Photo Successfully Upload!</div>');
