...
<li><span class="bread-blod">Testimonials</span>
</li>
</ul>
</div>
</div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Testimonials Add</a></li>
                                 <li><a href="#reviews"> Testimonials Details</a></li>
...
<?php
 include("config.php");
  ...
  $select=mysql_query("SELECT * FROM testimonials;");
  $i=0;
